...
def test_aws_scan_finds_gpu_instances(mock_boto3_clients):
    ...
    # Mock CloudTrail attribution via paginator
    mock_paginator = MagicMock()
    ct.get_paginator.return_value = mock_paginator
    ...
    # Mock batch metrics
    adapter._get_batch_metrics = MagicMock(return_value={
        'i-gpu-123': {'max_cpu': 0.5, 'network_in': 0.0}
    })
